...
urlpatterns = [
    ...
    path('curso/<int:curso_id>/edit/', souffle.curso_edit, name='curso_edit'),
    path('curso/<int:curso_id>/delete/', souffle.curso_delete, name='curso_delete'),
    path('curso/<int:curso_id>/review/add/', souffle.add_review, name='add_review'),
    path('review/<int:review_id>/delete/', souffle.delete_review, name='delete_review'),
